...
public class EmptyLayout {
     ...
     * @param listView
     */
    public void setListView(EmptyRecyclerView listView) {
     ...
     * @param meViewssageId    the id of the text view within the empty layout whose text will be changed into this message
     */
     ...
     *
     * @paramLoadingEmptyButton will a button be shown in the loading view
     */
     ...
     *
     * @param rrorEmptyButton will a button be shown in the error view
     */
     ...
     */
    public EmptyLayout(Context context ,EmptyRecyclerView listView) {
        mContext = context;
        mInflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mListView = listView;
    }
